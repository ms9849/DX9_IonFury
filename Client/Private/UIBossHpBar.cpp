...
CUIBossHpBar::CUIBossHpBar(LPDIRECT3DDEVICE9 pGraphic_Device)
...
HRESULT CUIBossHpBar::Ready_Components()
{
	...
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::STATIC), TEXT("Prototype_Component_VIBuffer_Rect"),
		...
		return E_FAIL;
	/* Com_Texture */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::BOSSFIGHT), TEXT("Prototype_Component_Texture_Monster_Boss_HpBar"),
...
CUIBossHpBar* CUIBossHpBar::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CUIBossHpBar* pInstance = new CUIBossHpBar(pGraphic_Device);
