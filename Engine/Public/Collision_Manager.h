...
public:
	...
	void	Check_RayToOBBCollision(const _wstring& strLayerTagRay, const _wstring& strLayerTagAABB, _uint iLayerLevel, _float fTimeDelta, _float3* vColisionPos);
private:
...
private:
	...
	_bool	RayToOBB_Collision(class CGameObject* pRay, class CGameObject* pOBB, _float3* vPos, CComponent** pCollider, _float fTimeDelta, _float3* vPlaneNormal);
