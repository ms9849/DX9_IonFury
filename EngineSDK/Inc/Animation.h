...
public:
	typedef struct tagFrame
	{
		...
		//_float		fFrameSpeed{}; // 애니메이션이 도는 속도
		_float		fTime{};		// 애니메이션 구동 시간
		//_float		fRunTime{};		// 애니메이션 유지 시간
	}FRAME_DESC;
...
public:
	...
	//void Set_Animation_Length(_uint iNumFrameLength);
	FRAME_DESC* Get_Animation();
	_uint Get_Frame_Index();
	void Play_Animation(_float fTimeDelta);

private:
	//_uint			m_iNumFrameLength{};
	//_float			m_iNumFrameIndex{};
	FRAME_DESC*						m_tFrame{};
